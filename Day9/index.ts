...
let coordinates: [number, number] = [40.7128, "-74.0060"]; // Tuple for latitude and longitude
...
names.addItems("Gokul");
names.addItems("Yady");
names.addItems("Dilip");
